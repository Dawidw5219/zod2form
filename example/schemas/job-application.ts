...
export const schema = f.object({
  ...
  portfolio:  f.string().url("Must be a valid URL").optional().field("text").label("Portfolio URL").placeholder("https://github.com/anna"),
  ...
  startDate:  f.string().date("Use YYYY-MM-DD").field("text").label("Available from").placeholder("2025-09-01"),
